...
namespace ergometer.csafe {
  ...
  export function registerStandardSet<T extends ICommandParamsBase>(
    ...
    commandManager.register(
      (buffer: IBuffer, monitor: PerformanceMonitorBase) => {
  ...
  export function registerStandardGetConfig<T extends ICommandParamsBase, U>(
    functionName: string,
    detailCommand: number,
        ...
        buffer[functionName] = function (params: T): IBuffer {
          buffer.addRawCommand({
            ...
            onDataReceived: (data: DataView) => {
              params.onDataReceived(<U>converter(data));
            },
            onError: params.onError,
          });
          return buffer;
  ...
  export function registerStandardProprietarySetConfig<
    T extends ICommandParamsBase
  >(functionName: string, command: number, setParams: (params: T) => number[]) {
    commandManager.register(
      (buffer: IBuffer, monitor: PerformanceMonitorBase) => {
        buffer[functionName] = function (params: T): IBuffer {
          buffer.addRawCommand({
  ...
  export function registerStandardProprietarySetData<
    T extends ICommandParamsBase
  >(functionName: string, command: number, setParams: (params: T) => number[]) {
    commandManager.register(
      (buffer: IBuffer, monitor: PerformanceMonitorBase) => {
  ...
  export function registerStandardProprietaryGetConfig<
    T extends ICommandParamsBase,
    U
  >(
    functionName: string,
  ...
  export function registerStandardProprietaryGetData<
    T extends ICommandParamsBase,
    U
  >(
    functionName: string,
